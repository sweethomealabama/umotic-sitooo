        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="glyphicon glyphicon-home"></i> <span>U-Motic | Installatore</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="javascript:;"><i class="fa fa-user pull-right"></i> Profilo</a></li>
                    <li><a href="javascript:;"><i class="fa fa-cogs pull-right"></i> Opzioni</a></li>
