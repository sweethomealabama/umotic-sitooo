...
<html lang="en">
  <head>
    ...
    <title>U-Motic | Modifica Profilo</title>
        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Profilo <small> Modifica</small></h3>
              </div>
            </div>
          </div>
          <br>
          ...
          <br>
            <form id="modifica_profilo" method="post" action="modifica_Utente_query.php">
              ...
              <div align="left">
                <input type="password" class="form-control" autocomplete="off" name="password" required = "" placeholder="Conferma vecchia Password"/>
              </div>
              <br>
              <div align="center">
