        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="glyphicon glyphicon-home"></i> <span>U-Motic</span></a>
            </div>
                    ...
                    <div>
                      ...
                      <div class="">
                        <div class="progress progress_sm" style="width: 76%;">
                          <div id="maxValue" class="progress-bar bg-green" role="progressbar" data-transitiongoal="30"></div>
                        </div>
                      </div>
                    </div>
                    <div>
