...
<html lang="en">
  <head>
    ...
    <title>U-Motic | Crea Sensore</title>
    ...
    <div class="container body">
      <div class="main_container">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Funzioni <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="index2.html">Aggiungi Sensore</a></li>
        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Installatore <small> Crea Sensore</small></h3>
              </div>
            </div>
          </div>
          <br>
          <br>
          <br>
            <form id="modifica_profilo" method="post" action="crea_sensore_query.php">
            <br>
              <div>
                <input type="text" class="form-control" placeholder="ID Sensore" required="" name="id"/>
              </div>
              <br>
              <div>
              ...
              <br>
              <div>
                <input type="text" class="form-control" placeholder="Marca Sensore" required="" name="marca">
              </div>
              <br>
              
              
              <div align="center">
                <input type="submit" class="btn btn-default" name="submit" value="Crea nuovo Sensore"/>
              </div>
              <div class="clearfix"></div>
                <div class="clearfix"></div>
                <br />
