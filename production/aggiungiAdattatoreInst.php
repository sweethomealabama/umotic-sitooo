...
<html lang="en">
  <head>
    ...
    <title>U-Motic | Crea Adattatore</title>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Installatore <small> Crea Adattatore</small></h3>
              </div>
            </div>
          </div>
          <br>
          <br>
          <br>
            <form id="modifica_profilo" method="post" action="aggiungi_adattatore_query.php">
            <br>
              
            <div>
                <input type="text" class="form-control" placeholder="ID Adattatore" required="" name="IDAdattatore"/>
              </div>

              <br>
              <div>
                <input type="text" class="form-control" placeholder="Nome Adattatore" required="" name="nomeAdattatore"/>
              </div>
              ...
              <div align="center">
              <input type="submit" class="btn btn-default" name="crea" value="Crea Adattatore"/>
              </div>
              <div class="clearfix"></div>
                <div class="clearfix"></div>
                <br />
