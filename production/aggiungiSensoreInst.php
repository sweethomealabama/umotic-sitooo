...
<html lang="en">
  <head>
    ...
    <title>U-Motic | Aggiungi Sensore</title>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Installatore <small> Aggiungi Sensore</small></h3>
              </div>
            </div>
          </div>
          <br>
          <br>
          <br>
            <form id="modifica_profilo" method="post" action="aggiungi_sensore_query.php">
            <br>
            <br>
                <br>
            <div>
                <select class="form-control">
                  <option>111111  -  Temperatura  -  SAMSUNG</option>
                  <option>345222  -  Luce  -  ONEPLUS</option>
                  <option>998337  -  Sismico  -  HUAWEI</option>
                  <option>122833  -  Pressione  -  ROCKSTAR</option>
              ...
              <div align="center">
                <a href="aggiungiSensoreFineInst.php"><input class="btn btn-default" value="Avanti"/></a>
              </div>
              <div class="clearfix"></div>
                <div class="clearfix"></div>
                <br />
