        ...
        <div class="right_col" role="main">
          ...
          <br>
            <form id="modifica_profilo" method="post" action="crea_formattazione_query.php">
              ...
              <br>
              <div>
                <input type="text" class="form-control" placeholder="Valore Sensore" required="" name="valore"/>
              </div>
              <br>
              <div>
                <input type="text" class="form-control" placeholder="Interpretazione Sensore" required="" name="interpretazione">
              </div>
              <br>
