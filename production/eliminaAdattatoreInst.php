...
<html lang="en">
  <head>
    ...
    <title>U-Motic | Rimuovi Adattatore</title>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Installatore <small> Rimuovi Adattatore</small></h3>
              </div>
            </div>
          </div>
          <br>
          <br>
          <br>
            <form id="modifica_profilo" method="post" action="elimina_adattatore_query.php">
            <br>

            <?php
            
              $sql="SELECT IDUtente FROM installazioneadattatore WHERE IDAdattatore = 'A048Q' ";
              ...
              //  for($i=0; $i<$num; $i++){
             //   $ID = $rows[$i];
              // echo "<select name=IDUtente action='post'>
...
<br>
           ...
           <div>
                <input type="text" class="form-control" placeholder="ID Adattatore" required="" autocomplete = "off" name="IDAdattatore"/>
              </div>
              ...
              <div align="center">
              <input type="submit" class="btn btn-default" name="rimuovi" value="Rimuovi Adattatore"/>
              </div>
              <div class="clearfix"></div>
                <div class="clearfix"></div>
                <br />
