          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Installatore <small>Seleziona Ambiente</small></h3>
              </div>
            </div>
          </div>
          <br>
            ...
            <br>
              ...
              <div>
                <select class="form-control">
                  <option>ambiente_1</option>
                  <option>Soggiorno</option>
                  <option>Garage_1</option>
                </select>
              </div>
              ...
              <div align="center">
                <input type="submit" name="aggiungi" class="btn btn-default" value="Aggiungi Sensore"/></a>
              </div>
              <div class="clearfix"></div>
                <div class="clearfix"></div>
                <br />
